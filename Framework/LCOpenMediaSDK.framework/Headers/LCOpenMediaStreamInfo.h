...
/* 所要请求码流的加密类型（能力集转换：HSEncrypt→1 / 私有协议→2 / TCM→3 / std_newChip→5；国标 GB28181 固定 0）
...
// RTSV1:支持私有协议拉流,RTSP:RTSP拉流 参数空默认为RTSP拉流；国标 GB28181 固定 RTSV1
