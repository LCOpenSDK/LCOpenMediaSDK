...
@interface LCNewVideoHistoryView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation LCNewVideoHistoryView
...
-(void)setupView{
    ...
    NSString *path = [[NSBundle mainBundle] pathForResource:@"LCNewLivePreviewModuleBundle" ofType:@"bundle"];
    NSBundle *mediaBundle = [NSBundle bundleWithPath:path];
    [self.videotapeList registerNib:[UINib nibWithNibName:@"LCNewVideotapeHistoryCell" bundle:mediaBundle] forCellWithReuseIdentifier:@"LCNewVideotapeHistoryCell"];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    LCNewVideotapeHistoryCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"LCNewVideotapeHistoryCell" forIndexPath:indexPath];
