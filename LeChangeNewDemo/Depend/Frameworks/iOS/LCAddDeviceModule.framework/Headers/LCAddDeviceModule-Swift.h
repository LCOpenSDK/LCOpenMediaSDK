...
/// 是否通过自发现（蓝牙搜索）进行配网
@property (nonatomic) BOOL isEntryFromBluetoothDiscovery;
/// 蓝牙设备名称（用于自发现配网）
@property (nonatomic, copy) NSString * _Nonnull bluetoothDeviceName;
/// 蓝牙设备产品ID（用于自发现配网）
@property (nonatomic, copy) NSString * _Nonnull bluetoothProductId;
/// 是否支持弱绑定
@property (nonatomic) BOOL isSupportWeakBind;
/// 设备验证码,弱绑定从设备获取
...
/// 蓝牙设备模型
SWIFT_CLASS("_TtC17LCAddDeviceModule22LCBluetoothDeviceModel")
@interface LCBluetoothDeviceModel : NSObject
/// 产品ID
@property (nonatomic, copy) NSString * _Nonnull productId;
/// 设备ID（序列号）
@property (nonatomic, copy) NSString * _Nonnull deviceId;
/// 蓝牙名称（设备序列号后四位）
@property (nonatomic, copy) NSString * _Nonnull bluetoothName;
/// 显示名称：PID-蓝牙名称
@property (nonatomic, readonly, copy) NSString * _Nonnull displayName;
/// 是否被选中
@property (nonatomic) BOOL isSelected;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithProductId:(NSString * _Nonnull)productId deviceId:(NSString * _Nonnull)deviceId bluetoothName:(NSString * _Nonnull)bluetoothName OBJC_DESIGNATED_INITIALIZER;
@end
