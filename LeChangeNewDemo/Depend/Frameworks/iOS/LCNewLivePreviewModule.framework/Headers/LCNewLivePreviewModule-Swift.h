...
@interface LCVisualTalkViewController (SWIFT_EXTENSION(LCNewLivePreviewModule)) <LCOpenMediaLiveDelegate>
/// 开始播放
...
@interface LCVisualTalkViewController (SWIFT_EXTENSION(LCNewLivePreviewModule)) <LCVisualTalkPlayerDelegate>
